...
<script type='text/javascript' src='/Public/webjs/global.js'></script> <!--下雪特效-->
<script>
    var _hmt = _hmt || [];
   (function() {
...
<header><h2>
	...
	<?php if($vo['post_status'] == 5): ?>????<?php endif; ?>
 ...
 $content=$vo['post_content']; $content=preg_replace('/\<.*\>/uisU'," ",$content); echo $content= htmlspecialchars(sub_str($content,0,120,0)).'....'; ?>
		��<a href="/index.php/Home/bbs/read/id/<?php echo ($vo["post_id"]); ?>.html" rel="nofollow" class="more-link">�����Ķ� &raquo;</a></span>
<p class="auth-span">
...
<span class="muted"><i class="fa fa-clock-o"></i>
	<?php echo ($vo["post_date"]); ?>
		...
		<span class="muted">
			<i class="fa fa-eye"></i>
				<span class="count"><?php echo ($vo["post_hot"]); ?></span>�˿���
		</span></p>
