...
body.custom-background { background-image: url('/Public/webcss/bg.png'); background-repeat: repeat; background-position: top left; background-attachment: scroll; }
  ...
  top: 0px;
    ...
    <script>
window._deel = {name: 'Recreate',url: 'https://yxom.6b7.net/', ajaxpager: '', commenton: 0, roll: [0,0]}
</script>
<script>
    var _hmt = _hmt || [];
   (function() {
...
<div class="content-wrap">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 20 );++$i;?><article class="excerpt">
<?php echo ($mod+1); ?>.
	ID:<?php echo ($vo["user_id"]); ?>:<a href=/index.php/Home/Home/zone/id/<?php echo ($vo["user_id"]); ?>><?php echo ($vo["user_name"]); ?></a>
	<br>
	禁止操作的方面:
	<br>
	<?php if($vo["user_status"] == 0): ?>#用户未激活
	<?php elseif($vo["user_status"] == 2): ?>
	#禁止修改资料
	<?php elseif($vo["user_status"] == 3): ?>
	#禁止论坛发帖
	<?php elseif($vo["user_status"] == 6): ?>
	#禁止聊天室发言
	<?php elseif($vo["user_status"] == 7): ?>
	#禁止回帖
	<?php elseif($vo["user_status"] == 8): ?>
	#禁止所有行为
	<?php else: endif; ?>
	<br>
	TA被关进这里的原因是:<?php echo ($vo["user_violations_content"]); ?>
...
<div class="footer-inner">
	<div class="footer-copyright" align="center">
		Copyright 2015-2017   YTech & ICECMS  | <a rel="nofollow" target="_blank" href="http://szerver.szhome.win/about">ABOUT US</a> | <a rel="nofollow" target="_blank" href="/index.php/Home/Home/dark_home.html">DARK HOUSE</a> <img id="webimg" src="/Public/web.png"><br />
