...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 20 );++$i; if($mod%2 != 0): ?><div class="bbs_title">
	...
	<?php echo ($mod+1); ?>.
	<a href=/index.php/Home/Bbs/read/id/<?php echo ($vo["post_id"]); ?>><?php echo ($vo["post_title"]); ?></a>
	<div class="line_title"><a href=/index.php/Home/Home/zone/id/<?php echo ($vo["post_ower_id"]); ?>.html><span style="color:#FFABAB"><?php echo ($vo["post_ower_name"]); ?></span></a>
	<span class="sm"><?php echo ($vo["post_date"]); ?></span><span class="right"><?php echo ($vo["post_hot"]); ?>阅</span>
</div>
</div><?php endforeach; endif; else: echo "" ;endif; ?>
<?php echo ($page); ?>
<a href="/index.php/Home/Bbs">返回</a>
