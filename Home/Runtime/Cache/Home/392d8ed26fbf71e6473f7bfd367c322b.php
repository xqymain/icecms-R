...
<div class="content-wrap">
	...
	<form name="LoginForm" action="/index.php/Home/Bbs/add_do.html"enctype="multipart/form-data" method="post">
		<p>
		...
		<div class="we1">
			<input type="submit" name="submit" value="发表" class="bbs_post"/>	
		</div>
		</p>
	</form>
...
<div class="footer-inner">
	<div class="footer-copyright" align="center">
		Copyright 2015-2017   YTech & ICECMS  | <a rel="nofollow" target="_blank" href="http://szerver.szhome.win/about">ABOUT US</a> | <a rel="nofollow" target="_blank" href="/index.php/Home/Home/dark_home.html">DARK HOUSE</a> <br />
