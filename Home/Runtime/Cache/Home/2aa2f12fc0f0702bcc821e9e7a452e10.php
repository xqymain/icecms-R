...
<div class="bbs_line"><a href="/index.php/Home/Index/index">首页</a>><a href="/index.php/Home/Bbs/index">论坛</a>><?php echo ($title); ?>><a href="/index.php/Home/Bbs/add">发帖</a></div>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 20 );++$i; if($mod%2 != 0): ?><div class="bbs_title">
	...
	<?php echo ($mod+1); ?>.
	<a href=/index.php/Home/Bbs/read/id/<?php echo ($vo["post_id"]); ?>.html><?php echo ($vo["post_title"]); ?></a>
