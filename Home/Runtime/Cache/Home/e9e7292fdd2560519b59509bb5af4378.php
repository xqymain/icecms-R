...
<title><?php echo ($user_name); ?>_修改头像</title>
...
<ul class="user-titbox">
	...
	<form action="/index.php/Home/Home/change_user_head_do" enctype="multipart/form-data" method="post" name="uploadfile">
<div align="left" class="open-message">	<li class="title_bbs">	<input type="file" name="upfile" />（图片大小<=2M）</li></div >
<li class="title_bbs"><input type="submit" name="submit"  class="action" value="确定上传（修改）"/>
	</form>	
</ul>
	</div>
	</div>
