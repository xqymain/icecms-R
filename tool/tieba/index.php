...
<title>查看贴吧用户动态与资料_icecms</title>
	...
	<div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
		...
		<div class="form-inline-block">
			<div class="input-group">
				<input id="sears" type="text" placeholder="请输入百度ID" onkeydown="if(event.keyCode==13){$('#search').click()}" class="form-control input-lg"><br />
...
<a href="http://icecms.cn">致谢ICE！</a><br />
</body>
</html>
