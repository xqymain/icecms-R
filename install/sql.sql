...
(1, 'admin', '82650bc8b3c381adfafce6178dd8925d', '183.61.236.90', '112.236.229.34', '2017-05-07 12:11:36', '2017-02-09 21:34:11', 'f6925de5c5888c8e835efe6fe82a3982');
...
--
-- 表的结构 `icebbs_article_board`
--

CREATE TABLE `icebbs_article_board` (
  `article_board_id` int(2) NOT NULL,
  `article_board_name` varchar(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `icebbs_article_board`
--
...
--
-- 表的结构 `icebbs_article_set`
--

CREATE TABLE `icebbs_article_set` (
  `article_set_id` int(2) NOT NULL,
...
--
-- 表的结构 `icebbs_atmessage`
--

CREATE TABLE `icebbs_atmessage` (
  `atmessage_id` int(11) NOT NULL,
...
--
-- 表的结构 `icebbs_bbs_board`
--

CREATE TABLE `icebbs_bbs_board` (
  `bbs_board_id` int(2) NOT NULL,
  `bbs_board_name` varchar(30) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `icebbs_bbs_board`
--
...
(1, '兖州之家 AlphaV5', '2017/5/7<br />\r\n协议:自由开源<br />\r\n环境PHP7/MYSQL<br />\r\n使用AWS强劲驱动！<br />\r\n感谢各位大神指导<br />', 1, '2017-05-07 12:30:36', 1, NULL, 13, 1, 'BUG', '2017-05-16 12:40:29', '2016-02-05 21:30:36', '183.61.236.90', 'Mozilla/5.0 (Windows NT 20.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36'),
(2, '试了一下', '速度还可以。最近一段时间会加紧更新，争取早日脱坑，偶不，是早日[code]while(true) printf("Running")[/code]<br />\n很多项目我决定托管Github，希望大家长期关注。This is my GitHub ： https://github.com/xqymain', 1, '2017-05-10 21:11:19', 1, NULL, 3, 1, 'admin', '2017-05-10 21:53:13', '2017-05-10 21:11:19', '182.41.90.199', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36');

-- --------------------------------------------------------

--
-- 表的结构 `icebbs_bbs_respond`
--
...
--
-- 表的结构 `icebbs_bbs_vote`
--

CREATE TABLE `icebbs_bbs_vote` (
  `bbs_vote_id` int(11) NOT NULL,
...
--
-- 表的结构 `icebbs_post_set`
--

CREATE TABLE `icebbs_post_set` (
  `post_set_id` int(2) NOT NULL,
...
(1, 0, '兖州之家-Server（AWS）', 'Home of Yanzhou！', '', 0, 1000, 3600, 1, 0, 1, 'Deep Learning,IoT,System', 20, 15, 4, 5, 0, '');
...
--
-- Indexes for table `icebbs_accessory`
--
ALTER TABLE `icebbs_accessory`
  ADD PRIMARY KEY (`accessory_id`);

--
-- Indexes for table `icebbs_admin`
--
ALTER TABLE `icebbs_admin`
  ADD PRIMARY KEY (`admin_id`);

--
-- Indexes for table `icebbs_article`
--
ALTER TABLE `icebbs_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `icebbs_article_board`
--
ALTER TABLE `icebbs_article_board`
  ADD PRIMARY KEY (`article_board_id`);

--
-- Indexes for table `icebbs_article_respond`
--
ALTER TABLE `icebbs_article_respond`
  ADD PRIMARY KEY (`respond_id`);

--
-- Indexes for table `icebbs_article_set`
--
ALTER TABLE `icebbs_article_set`
  ADD PRIMARY KEY (`article_set_id`);

--
-- Indexes for table `icebbs_atmessage`
--
ALTER TABLE `icebbs_atmessage`
  ADD PRIMARY KEY (`atmessage_id`);

--
-- Indexes for table `icebbs_bbs_board`
--
ALTER TABLE `icebbs_bbs_board`
  ADD PRIMARY KEY (`bbs_board_id`);

--
-- Indexes for table `icebbs_bbs_post`
--
ALTER TABLE `icebbs_bbs_post`
  ADD PRIMARY KEY (`post_id`);

--
-- Indexes for table `icebbs_bbs_respond`
--
ALTER TABLE `icebbs_bbs_respond`
  ADD PRIMARY KEY (`respond_id`);

--
-- Indexes for table `icebbs_bbs_vote`
--
ALTER TABLE `icebbs_bbs_vote`
  ADD PRIMARY KEY (`bbs_vote_id`);

--
-- Indexes for table `icebbs_chat`
--
ALTER TABLE `icebbs_chat`
  ADD PRIMARY KEY (`chat_id`);

--
-- Indexes for table `icebbs_message`
--
ALTER TABLE `icebbs_message`
  ADD PRIMARY KEY (`message_id`);

--
-- Indexes for table `icebbs_post_set`
--
ALTER TABLE `icebbs_post_set`
  ADD PRIMARY KEY (`post_set_id`);

--
-- Indexes for table `icebbs_user`
--
ALTER TABLE `icebbs_user`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `user_id` (`user_id`),
  ADD KEY `user_id_2` (`user_id`);

--
-- Indexes for table `icebbs_website`
--
ALTER TABLE `icebbs_website`
...
--
-- 使用表AUTO_INCREMENT `icebbs_accessory`
--
ALTER TABLE `icebbs_accessory`
  MODIFY `accessory_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_admin`
--
ALTER TABLE `icebbs_admin`
  MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `icebbs_article`
--
ALTER TABLE `icebbs_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
-- 使用表AUTO_INCREMENT `icebbs_article_board`
--
ALTER TABLE `icebbs_article_board`
  MODIFY `article_board_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `icebbs_article_respond`
--
ALTER TABLE `icebbs_article_respond`
  MODIFY `respond_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_article_set`
--
ALTER TABLE `icebbs_article_set`
  MODIFY `article_set_id` int(2) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_atmessage`
--
ALTER TABLE `icebbs_atmessage`
  MODIFY `atmessage_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_bbs_board`
--
ALTER TABLE `icebbs_bbs_board`
  MODIFY `bbs_board_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- 使用表AUTO_INCREMENT `icebbs_bbs_post`
--
ALTER TABLE `icebbs_bbs_post`
  MODIFY `post_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `icebbs_bbs_respond`
--
ALTER TABLE `icebbs_bbs_respond`
  MODIFY `respond_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_bbs_vote`
--
ALTER TABLE `icebbs_bbs_vote`
  MODIFY `bbs_vote_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- 使用表AUTO_INCREMENT `icebbs_chat`
--
ALTER TABLE `icebbs_chat`
  MODIFY `chat_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_message`
--
ALTER TABLE `icebbs_message`
  MODIFY `message_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_post_set`
--
ALTER TABLE `icebbs_post_set`
  MODIFY `post_set_id` int(2) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `icebbs_user`
--
ALTER TABLE `icebbs_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;
--
-- 使用表AUTO_INCREMENT `icebbs_website`
--
ALTER TABLE `icebbs_website`
